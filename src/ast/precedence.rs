...
impl PrefixPrecedence {
    ...
    pub fn default() -> HashMap<TokenKind, Self> {
        ...
        HashMap::from([
            ...
            (
                TokenKind::ParenL,
                Self::new(0, GROUP).with_suffix(TokenKind::ParenR, AstErrorKind::UnterminatedParen),
            ),
        ])
    }
}
...
impl InfixPrecedence {
    ...
    pub fn default() -> HashMap<TokenKind, Self> {
        ...
        HashMap::from([
            ...
            (TokenKind::PlusEq, Self::new(2, 0, ArithAssign(Add))),
            (TokenKind::MinusEq, Self::new(2, 0, ArithAssign(Sub))),
            (TokenKind::SlashEq, Self::new(2, 0, ArithAssign(Div))),
            (TokenKind::StarEq, Self::new(2, 0, ArithAssign(Mul))),
            (TokenKind::PercentEq, Self::new(2, 0, ArithAssign(Rem))),
            ...
            (TokenKind::Slash, Self::new(30, 31, Div.into())),
            ...
            (
                ...
                Self::new(100, 0, Index)
                    .with_suffix(TokenKind::BracketR, AstErrorKind::UnterminatedBracket),
            ),
        ])
    }
}
