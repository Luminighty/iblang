...
use super::{
    CompileResult, bindings::VariableBinding, compiler::Compiler, error::CompilerErrorKind,
};
...
impl<'ctx> Compiler<'ctx> {
    pub fn compile_statement(
        ...
        match &statement.kind {
            StatementKind::VarDeclaration {
                ...
                value,
                ty,
            } => self.var_declaration(module, ident, value, *mutable, ty, statement.span),
    ...
    fn var_declaration(
        ...
        let alloca_ty = match ty {
            ...
            _ => {
                return self.error(
                    CompilerErrorKind::InvalidVarDeclaration { ty: ty.clone() },
                    span,
                );
            }
        };
    ...
    fn ret(
        ...
        if let Some(value) = value {
            ...
            let value = self.compile_expr(module, value)?;
            let value =
                self.load_value(value, CompilerErrorKind::ValueExpected, value_span, "ret")?;
            match expected {
